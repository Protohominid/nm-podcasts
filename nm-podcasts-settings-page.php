...
class NMPodcastsSettingsPage {
	...
	public function google_analytics_tracking_callback() {
		printf(
			'<input type="text" id="google_analytics_tracking" name="nm_podcasts_options[google_analytics_tracking]" value="%s" /><br><em>Google Analytics property ID for tracking downloads (e.g. "UA-000000-00").</em>',
			isset( $this->options['google_analytics_tracking'] ) ? esc_attr( $this->options['google_analytics_tracking']) : ''
		);
	}
}
